...
class IssueController extends Controller
{
	...
	public $layout='//layouts/column2';
         ...
         * @param type $project_id - the primary identifier of the associated Project
         * @throws CHttpException
         * @return object - the Project data model based on the primary key
         */
        protected function loadProject($project_id)
        {
            // if the project propery is null, create it based on the input id
	...
	protected function performAjaxValidation($model)
	{
        ...
        /**
         * In-class defined filer method, configured for use in the above filters() method
         * It is called before the actionCreate() action method is run in order to ensure 
         * a proper project context
        ...
        /**
         * 
         * @return the project model instance to which this issue belongs 
         */
